package kcs.funding.fundingboost.domain.exception;
...
public enum ErrorCode {
    ...
    NOT_FOUND_TAG(40402, HttpStatus.NOT_FOUND, "해당 태그가 존재하지 않습니다."),
    NOT_FOUND_ITEM(40403, HttpStatus.NOT_FOUND, "해당 아이템이 존재하지 않습니다."),
